...
from .graph_domain import FilteredEntities  # noqa: F401 — kept for type re-export
from .entity_reader import get_entity_reader
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        try:
            ...
            # Backend-agnostic: respects GRAPH_BACKEND. PostgresEntityReader
            # exposes the same surface, so the rest of the pipeline is
            # unchanged when running on Postgres.
